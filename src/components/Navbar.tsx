...
export const Navbar: FC = () => {
  ...
  return (
    <div className="flex justify-between items-center mb-4 sticky top-0 bg-white border-emerald-500 border-b-2 z-100 py-5 px-4">
      <ul className="flex [&>*]:mr-4 text-lg font-medium">
        <li>
      ...
      <button
        onClick={openCart}
        className="relative border-2 rounded-full border-slate-150 p-3 hover:border-emerald-500 transition"
      >
