  ...
  return (
    <div className="relative">
      <button
        ...
        className="absolute top-4 left-4 z-10 py-3 px-6 border border-white rounded-lg text-white uppercase"
        onClick={handleUndo}
      >
        Undo
      </button>
      ...
      <button
        ...
        className="absolute top-4 left-32 z-10 py-3 px-6 border border-white rounded-lg text-white uppercase"
        onClick={handleRedo}
      >
        Redo
      </button>
